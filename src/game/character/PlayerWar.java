...
public class PlayerWar extends Player{
	...
	/**
	 * to create an army check if player has soldiers left
	 * check if the number of requested soldiers is greater than
	 * the number of the soldiers available, get the first empty slot
	 * in the units array, create a new army with that number of soldier 
	 * subtract the number of soldiers for the players available soldiers
